...
def test_hyperbus_model():
    required_file = Path(
        "../../test/memory_models/infineon-s27kl0641-simulationmodels-en/s27kl0641/model/s27kl0641.v"
    )
    ...
    runner.build(sources=sources, hdl_toplevel="HyperRAM_wrapper", always=True, waves=True)

    runner.test(hdl_toplevel="HyperRAM_wrapper", test_module="test_hyperbus_model", waves=True)
